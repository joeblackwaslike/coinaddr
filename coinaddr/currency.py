...
class Currency(metaclass=CurrencyMeta):
    ...
    validator = attr.ib(type=str, validator=attr.validators.instance_of(str))
    networks = attr.ib(
        type=dict,
...
Currency(
    ...
    ticker="bch",
    validator="Base58Check",
    networks=dict(main=(0x00, 0x05), test=(0x6F, 0xC4, 0x3A)),
)
Currency(
    "litecoin",
    ticker="ltc",
    validator="Base58Check",
    networks=dict(main=(0x30, 0x05, 0x32), test=(0x6F, 0xC4, 0x3A)),
)
Currency(
    "dogecoin",
    ticker="doge",
    validator="Base58Check",
    networks=dict(main=(0x1E, 0x16), test=(0x71, 0xC4)),
)
Currency(
    "dashcoin",
    ticker="dash",
    validator="Base58Check",
    networks=dict(main=(0x4C, 0x10), test=(0x8C, 0x13)),
)
Currency(
    "dogecoin",
    ticker="doge",
...
Currency("neocoin", ticker="neo", validator="Base58Check", networks=dict(both=(0x17,)))
Currency(
    "ripple",
    ticker="xrp",
    validator="Base58Check",
    networks=dict(both=(0x00, 0x05)),
    charset=(b"rpshnaf39wBUDNEGHJKLM4PQRST7VWXYZ2bcdeCg65jkm8oFqi1tuvAxyz"),
)
...
Currency(
    "bitcoin-segwit",
    ticker="btc-segwit",
    validator="SegWitCheck",
    networks=dict(main=("bc",), test=("tb",)),
)
Currency(
    "litecoin-segwit",
    ticker="ltc-segwit",
    validator="SegWitCheck",
    networks=dict(main=("ltc",), test=("tltc",)),
)
